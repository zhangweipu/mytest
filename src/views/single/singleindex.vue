<template>
  <el-carousel :interval="5000" arrow="always" :height="height1">
    <el-carousel-item v-for="item in 4" :key="item">
      ...
      <div class="pull-height animated" :style="{backgroundImage:'url('+imgUrl[item-1]+')'}"
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        content: "main",
        imgUrl: ["/static/background.jpg", "/static/dog.jpg", "/static/image/qiu.jpg", "/static/image/xia.jpg"],
